...
export default function Footer() {
	...
	return (
		<footer className={css.container} id="socials">
			<Container spacing={['verticalXXLrg', 'bottomLrg']}>
				<section style={{display: 'flex', justifyContent: 'center', alignItems: 'center' , padding: '3rem 0'}}>
					<ul className={css.social}>
						<li><h4>Social</h4></li>
						<li className={css.socialList}>
							<a href="https://leetcode.com/u/Shrey191/" rel="noreferrer" target="_blank">
							<svg className={css.leetcode} xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24" id="leetcode">
